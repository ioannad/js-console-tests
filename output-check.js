...
function test_console_methods_basic() {
  ...
  console.log("------- Testing console methods for basic functionality -------");

  // assert
  console.log(' --- console.assert(true, "should not be logged");');
  console.assert(true, "should not be logged");

  console.log(' --- console.assert(false, "Failed assertion logged.", "one", "two", 3);');
  console.assert(false, "Failed assertion logged.", "one", "two", 3);

  console.log(' --- console.assert(console.assert(true) == undefined);');
...
function test_formatter() {
  ...
  console.log(' --- console.log(\'bjoern and robert are born on the \%fst dec\', 1.234);');
  ...
  console.log(' --- console.log(\'bjoern and robert are born on the \%dst dec\', "foo");');
  ...
  console.log(' --- console.assert(false, "robert keeps \%s on his balcony", "plaices");');
  console.assert(false, "robert keeps %s on his balcony", "plaices")

  // console.assert - string formatter of an object
  console.log(' --- console.assert(false, "robert keeps \%s on his balcony", {foo: "bar"});');
...
function test_console_table() {
  ...
  console.log(' --- console.table("the plaice living on the balcony");');
  console.table("the plaice living on the balcony");

  // console.table - Sets
  console.log(' --- console.table(new Set([{name: "terin", owner: false}, {name: "robert", owner: false}, {name: "domenic", owner: true}]));');
  ...
  console.log(' --- console.table([[1, 2, 3, 4], [5, 6, 7, 8]], 2, 3);');
